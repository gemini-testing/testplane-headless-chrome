...
module.exports = async function(version, cachePath, downloadAttempts) {
    ...
    const passedVersion = version || await utils.getLastStableMajor(osName);

    let revision = await utils.getRevision(osName, passedVersion, cachePath);
    ...
    if (revision !== cachedRevision) {
        ...
        utils.saveRevision(osName, passedVersion, revision, cachePath).catch(e => console.error(e));
    }
